      ...
      <aside className="w-64 bg-white border-r border-slate-200/90 h-screen sticky top-0 flex flex-col justify-between p-5 z-40 shadow-xs">
        ...
        <div className="space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="text-[10px] font-mono px-2 py-0.5 rounded font-semibold theme-accent-light border inline-block mb-1.5">
        ...
        <div className="space-y-3 pt-4 border-t border-slate-100 text-xs">
          {showClock && (
            <div className="p-3 bg-slate-50 border border-slate-200/80 rounded-xl space-y-1 font-mono">
              ...
              <p className="text-[11px] text-slate-500 capitalize">{fechaLocal}</p>
            </div>
          )}

          {showHardware && (
            <div className="p-2.5 rounded-xl bg-emerald-50 border border-emerald-200 text-xs font-mono text-emerald-800 flex items-center justify-between">
              ...
              <span className="text-[11px] text-emerald-700">{appConfig.hardware.ip}</span>
            </div>
          )}
        </div>
      </aside>
